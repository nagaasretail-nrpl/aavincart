    ...
    <div className="min-h-screen lg:h-screen flex flex-col lg:flex-row overflow-hidden">
      <div className="hidden lg:flex lg:w-[45%] flex-shrink-0 relative">
        ...
        <div className="absolute bottom-8 left-8 right-8 text-white">
          <h2 className="text-3xl font-bold mb-2">Aavin Retailer Portal</h2>
          <p className="text-lg opacity-90">Order dairy products at retailer pricing</p>
        </div>
      </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 sm:p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <Input
                  type="text"
                  placeholder="e.g., SLM-1400 or 9876543210"
                  value={agentCode}
              ...
              <Button
                type="submit"
                className="w-full h-11 bg-gradient-to-r from-orange-500 to-orange-600 hover:opacity-90 text-white font-medium"
                disabled={isLoading}
              >
            ...
            <div className="mt-4 text-center text-sm text-gray-600">
              New retailer?{" "}
              <Link href="/agent-claim" className="text-orange-600 hover:underline font-medium">
                Claim Your Account
              </Link>
            </div>
          </div>
