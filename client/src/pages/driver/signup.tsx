    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50 flex items-center justify-center px-3 sm:px-4 py-6 sm:py-8">
      <Card className="w-full max-w-lg">
        <CardHeader className="text-center p-4 sm:p-6">
          ...
          <CardDescription className="text-sm">Join the Aavin Cart delivery team</CardDescription>
        </CardHeader>
        <CardContent className="p-4 sm:p-6">
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
            ...
            >
              ...
              {isLoading ? 'Registering...' : 'Register as Delivery Driver'}
            </Button>
          </form>
          ...
          <div className="mt-4 text-center text-sm text-gray-500">
            ...
            <Link href="/district-union/login" className="hover:underline">District Union Login</Link>
          </div>
        </CardContent>
      </Card>
    </div>
