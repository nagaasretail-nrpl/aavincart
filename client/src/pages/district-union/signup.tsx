...
export default function DistrictUnionSignup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await apiRequest('POST', '/api/district-union/signup', {
        name: formData.unionName,
        code: formData.unionCode,
      ...
      if (data.success) {
        toast({
          ...
          description: 'Your District Union application has been submitted for approval.'
        });
        setLocation('/district-union/login');
      } else {
        toast({
          title: 'Error',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center px-3 sm:px-4 py-6 sm:py-8">
        ...
        <CardContent className="p-4 sm:p-6">
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div>
                <label className="text-sm font-medium mb-1 block">Union Code</label>
                <Input
            ...
            <div>
              ...
              <Textarea
                placeholder="Complete address of the union office"
            ...
            <div>
              ...
              <Input
                type="email"
                placeholder="union.email@example.com"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div>
                <label className="text-sm font-medium mb-1 block">FSSAI License Number</label>
                <Input
            ...
            <Button 
              type="submit" 
              className="w-full h-11 sm:h-12 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700"
              disabled={isLoading}
            >
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              Already registered?{' '}
              <Link href="/district-union/login" className="text-green-600 hover:underline font-medium">
                Sign in
              </Link>
            </p>
          </div>
